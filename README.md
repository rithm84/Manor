...
<p align="center">
  <img src="docs/readme/home-dark.png" alt="Manor Home: the due-bucket task board beside the day's timeline" width="100%">
</p>
...
<table>
  <tr>
    <td width="50%"><img src="docs/readme/habits-dark.png" alt="Habits with per-habit streaks and the freeze pool"></td>
    <td width="50%"><img src="docs/readme/notes-dark.png" alt="Notes editor with headings, code, and lists"></td>
  </tr>
  <tr>
    <td width="50%"><img src="docs/readme/jobs-dark.png" alt="Jobs pipeline board from To apply to Decided"></td>
    <td width="50%"><img src="docs/readme/leetcode-dark.png" alt="LeetCode curriculum progress, weekly intensity, and mistakes"></td>
  </tr>
</table>

<details>
  <summary>Light mode</summary>
  <p align="center"><img src="docs/readme/home-light.png" alt="Manor Home in light mode" width="100%"></p>
</details>
