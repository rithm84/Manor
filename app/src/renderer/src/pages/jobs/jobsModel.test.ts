...
import { currentUpdateLabel, jobFlowData, postedLabel, toBoardCard } from './jobsModel'
...
describe('jobs presentation model', () => {
  ...
  it('aggregates durable forward and drop-off transitions for the Sankey', () => {
    const transitions: readonly JobStageTransition[] = [
      ...
      { id: '5', roleId: 'a', fromStage: 'oa', toStage: 'applied', changedAt: '2026-08-05T12:00:00.000Z' }
    ]
